...
import signal
import sys
from Class.MetaCLIP2 import MetaCLIP2
...
model = MetaCLIP2()  # MetaCLIP2 hiện bắt buộc CUDA và tự dùng GPU

main_path = "/dataset/AIC_2025/SIU_Sayan/keyframes"  # Đồng nhất với DFN5B_extraction
SAVE_DIR = "/dataset/AIC_2025/SIU_Sayan/autoshot/features_metaclip2"
