...
import signal
import sys
from Class.JinaCLIPV2 import JinaCLIPV2
...
model = JinaCLIPV2()  # JinaCLIPV2 hiện bắt buộc CUDA và tự dùng GPU

main_path = "/dataset/AIC_2025/SIU_Sayan/keyframes"  # Đồng nhất với DFN5B_extraction
SAVE_DIR = "/dataset/AIC_2025/SIU_Sayan/autoshot/features_jinaclipv2"
