...
def create_model(
    ...
    # Đảm bảo device luôn là torch.device object
    ...
    if pretrained.lower() == 'openai':
        ...
        import importlib
        # Sử dụng đường dẫn tuyệt đối thay vì đường dẫn cứng
        current_dir = os.path.dirname(os.path.abspath(__file__))
        mini_clip_dir = current_dir
        for model_code in os.listdir(mini_clip_dir):
