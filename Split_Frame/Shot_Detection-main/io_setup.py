...
class SceneJsonLoader:
    ...
    def save_results(self) -> None:
        ...
        def created_nested_structure(base_path: str, nested_dict: Dict) -> None:
            ...
            for key, value in nested_dict.items():
                ...
                if isinstance(value, dict):
                    ...
                    json_file_path = os.path.join(base_path, f"{key}.json")
        ...
        print(f"Input dict type: {type(self.input_dict)}")
        print(f"Input dict keys: {list(self.input_dict.keys()) if isinstance(self.input_dict, dict) else 'Not a dict'}")
